...
// Test NewConcurrentBloomFilter with valid options
func Test_NewConcurrentBloomFilter_Valid(t *testing.T) {
...
// Test NewConcurrentBloomFilter with multiple hash functions
func Test_NewConcurrentBloomFilter_MultipleHashFunctions(t *testing.T) {
	bf, err := bloomfilters.NewConcurrentBloomFilter(
		bloomfilters.WithSize(1024),
...
// Test NewConcurrentBloomFilter with zero size
...
func Test_NewConcurrentBloomFilter_InvalidSize(t *testing.T) {
...
// Test NewConcurrentBloomFilter with no hash functions (should fail)
func Test_NewConcurrentBloomFilter_NoHashFunctions(t *testing.T) {
	bf, err := bloomfilters.NewConcurrentBloomFilter(
		bloomfilters.WithSize(1024),
	)
	require.Error(t, err)
...
// Test NewConcurrentBloomFilter with nil hash function (should fail)
func Test_NewConcurrentBloomFilter_NilHashFunction(t *testing.T) {
	bf, err := bloomfilters.NewConcurrentBloomFilter(
		bloomfilters.WithSize(1024),
...
// Test NewConcurrentBloomFilter with mixed nil and valid hash functions (should fail)
func Test_NewConcurrentBloomFilter_MixedNilHashFunctions(t *testing.T) {
	bf, err := bloomfilters.NewConcurrentBloomFilter(
		bloomfilters.WithSize(1024),
		bloomfilters.WithHashFunctions([]bloomhashes.HashFunction{
			bloomhashes.Fnv1_64,
...
func Test_ConcurrentBloomFilter_AddAndTest_SingleHash(t *testing.T) {
	bf, err := bloomfilters.NewConcurrentBloomFilter(
		bloomfilters.WithSize(1024),
		bloomfilters.WithHashFunctions([]bloomhashes.HashFunction{bloomhashes.Fnv1_64}),
	)
...
func Test_ConcurrentBloomFilter_AddAndTest_MultipleHashes(t *testing.T) {
	bf, err := bloomfilters.NewConcurrentBloomFilter(
...
// Test empty data
func Test_ConcurrentBloomFilter_EmptyData(t *testing.T) {
	bf, err := bloomfilters.NewConcurrentBloomFilter(
		bloomfilters.WithSize(1024),
		bloomfilters.WithHashFunctions([]bloomhashes.HashFunction{bloomhashes.Fnv1_64}),
	)
...
func Test_ConcurrentBloomFilter_LargeData(t *testing.T) {
	bf, err := bloomfilters.NewConcurrentBloomFilter(
...
func Test_ConcurrentBloomFilter_SimilarData(t *testing.T) {
	bf, err := bloomfilters.NewConcurrentBloomFilter(
		bloomfilters.WithSize(1024),
		bloomfilters.WithHashFunctions([]bloomhashes.HashFunction{
			bloomhashes.Fnv1_64,
...
func Test_ConcurrentBloomFilter_AppendHashFunctions(t *testing.T) {
	bf, err := bloomfilters.NewConcurrentBloomFilter(
		bloomfilters.WithSize(1024),
		bloomfilters.WithHashFunctions([]bloomhashes.HashFunction{bloomhashes.Fnv1_64}),
...
func Test_ConcurrentBloomFilter_MultipleAdditions(t *testing.T) {
	bf, err := bloomfilters.NewConcurrentBloomFilter(
		bloomfilters.WithSize(1024),
		bloomfilters.WithHashFunctions([]bloomhashes.HashFunction{bloomhashes.Fnv1_64}),
	)
...
func Test_ConcurrentBloomFilter_AllHashFunctions(t *testing.T) {
...
func Fuzz_ConcurrentBloomFilter_AddTest(f *testing.F) {
	// Add seed corpus
	f.Add([]byte("test"))
...
func ExampleConcurrentBloomFilter() {
...
func ExampleConcurrentBloomFilter_multipleHashes() {
